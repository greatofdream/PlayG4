...
//
//
/// \file PlayG4ChamberParameterisation.cc
/// \brief Implementation of the PlayG4ChamberParameterisation class
...
PlayG4ChamberParameterisation::PlayG4ChamberParameterisation(  
        G4int    noChambers, 
 ...
 : G4VPVParameterisation()
{
   ...
   if( noChambers > 0 ){
      ...
      if (spacingZ < widthChamber) {
         G4Exception("PlayG4ChamberParameterisation::PlayG4ChamberParameterisation()",
...
void PlayG4ChamberParameterisation::ComputeTransformation
...
void PlayG4ChamberParameterisation::ComputeDimensions
